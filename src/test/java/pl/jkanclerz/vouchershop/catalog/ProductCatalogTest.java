...
public class ProductCatalogTest {
    ...
    private static final String PRODUCT_PICTURE = "http://nice_picture";
    private static final String PRODUCT_DESC = "My nice product";
    ...
    @Test
    public void itAllowsLoadCreateProduct() {
        //Arrange
        ProductCatalog catalog = thereIsProductCatalog();
        //Act
        String productId = catalog.registerProduct();
